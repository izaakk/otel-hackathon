...
export default function EditProfile(props) {
  ...
  useEffect(() => {
    if (
      ...
      setTextFieldTwoNineSevenSixSixNineTwoTwoValue(profile?.name);
  }, [profile]);
  useEffect(() => {
    if (
      textFieldThreeFourSixSevenTwoSevenOneSixValue === "" &&
      ...
      setTextFieldThreeFourSixSevenTwoSevenOneSixValue(profile?.geo);
  }, [profile]);
  useEffect(() => {
    if (
      textFieldThreeFourFiveOneTwoSixEightNineValue === "" &&
      ...
      setTextFieldThreeFourFiveOneTwoSixEightNineValue(profile?.role);
  }, [profile]);
  useEffect(() => {
    if (
      textFieldThreeFourFiveOneTwoSevenOneZeroValue === "" &&
      profile !== undefined &&
      profile?.businessunit !== undefined
    )
      setTextFieldThreeFourFiveOneTwoSevenOneZeroValue(profile?.businessunit);
  }, [profile]);
  return (
    <Flex
      gap="16px"
